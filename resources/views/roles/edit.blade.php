            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                        value="<?php echo e($role->name); ?>" placeholder="e.g. Administrator">
                    @error('name')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="description"
                        class="form-control @error('description') is-invalid @enderror" value="<?php echo e($role->description); ?>"
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="heading-<?php echo e($group); ?>">
                        <button class="accordion-button <?php echo e($loop->first ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapse-<?php echo e($group); ?>" aria-expanded="<?php echo e($loop->first ? 'true' : 'false'); ?>"
                            aria-controls="collapse-<?php echo e($group); ?>">
                            <?php echo e(ucfirst($group)); ?> Management
                        </button>
                    </h2>
                    <div id="collapse-<?php echo e($group); ?>" class="accordion-collapse collapse <?php echo e($loop->first ? 'show' : ''); ?>"
                                ...
                                <div class="col-md-3">
                                    <label class="perm-chip w-100 text-center">
                                        <input type="checkbox" name="permissions[]" value="<?php echo e($permission->id); ?>"
                                            class="permission-checkbox" <?php echo e(in_array($permission->id, $rolePermissions) ? 'checked' : ''); ?>>
...
<link rel="stylesheet" href="<?php echo e(asset('css/resize/role-permission-compact.css')); ?>">
<?php $__env->stopPush(); ?>
